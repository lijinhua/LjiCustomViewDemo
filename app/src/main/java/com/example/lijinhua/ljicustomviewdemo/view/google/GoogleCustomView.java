...
*/
package com.example.lijinhua.ljicustomviewdemo.view.google;
 ...
 */
public class GoogleCustomView extends ViewGroup {
    ...
    public interface OnCurrentItemChangedListener {
        void OnCurrentItemChanged(GoogleCustomView source, int currentItem);
    }

    /**
     * Class constructor taking only a context. Use this constructor to create
     * {@link GoogleCustomView} objects from your own code.
     *
     * @param context
     */
    public GoogleCustomView(Context context) {
        super(context);
        init();
    }
     ...
     * is used by the layout engine to construct a {@link GoogleCustomView} from a set of
     * XML attributes.
     *
     * @param context
     ...
     *                from {@link View}.
     */
    public GoogleCustomView(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        try {
            ...
            mShowText = a.getBoolean(R.styleable.PieChart_customShowText, false);
    ...
    private void init() {
        ...
        if (Build.VERSION.SDK_INT >= 11) {
            mAutoCenterAnimator = ObjectAnimator.ofInt(GoogleCustomView.this, "PieRotation", 0);
        ...
        mDetector = new GestureDetector(GoogleCustomView.this.getContext(), new GestureListener());
